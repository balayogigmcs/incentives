...
import 'package:web/appbar/popup_buttons/individual_programs_pages.dart';
import 'package:web/body_styling.dart';
import 'package:web/appbar/information.dart';
import 'package:web/appbar/popup_buttons/categories.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('USA INCENTIVES'),
        backgroundColor: Color.fromARGB(255, 32, 173, 239),
        actions: [
                 ...
                 PopupMenuItem(
                  ...
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => IndividualProgramPages()));
                  },
                ),
                const PopupMenuItem(
                  value: 'Individual Program Pages',
